...
def generate_mdvrp_data(dataset_size, vrp_size, depot_size, rng):
    """
    dataset_size: how many instances to create
    tsp_size: how many customers per instance
    depot_size: how many depots per instance
    ...
    return list(zip(
        rng.uniform(size=(dataset_size, depot_size, 2)).tolist(), #Depot locations
        rng.uniform(size=(dataset_size, vrp_size, 2)).tolist(), #customer locations
        rng.integers(low=1, high=10, size=(dataset_size, vrp_size)).tolist(), #demands, uniform integer [1, 10)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--problem", type=str, default=None, help="Problem, 'vrp', 'mdvrp'") 
    parser.add_argument('--data_distribution', type=str, default='all',
                        help="Distributions to generate for problem, default 'all'.")

    parser.add_argument("--dataset_size", type=int, default=10000, help="Size of the dataset")
    parser.add_argument("--depot_size", type=int, default=None, 
                        help="Number of depots for mdvrp")
